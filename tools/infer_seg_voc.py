...
parser.add_argument("--test_data_folder", default='/home/ac/data/lk/FP/FP_3/VOCdevkit/VOC2012', type=str, help="dataset folder")

parser.add_argument("--pooling", default="gmp", type=str, help="pooling method")
parser.add_argument("--model_path", default="/home/ac/data/lk/FP/FP_3/result/fp3_1__5_9/2025-07/voc_train_voc_24-20-53-39/checkpoints/model_iter_20000.pth", type=str, help="model_path")
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            for sc in args.scales:
                ...
                segs = model(inputs_cat,cls_label=cls_label)[1]
...
if __name__ == "__main__":
    ...
    base_dir = args.model_path.split("checkpoints/")[0] + f'/{args.infer_set}/'+ "try"
