...
from model.model_mal_prototype import network
...
# parser.add_argument("--model_path", default="/home/ac/data/lk/FP/FP_3/result/fp3_2__5_11__cuda0/2025-05/voc_train_voc_15-16-43-36/checkpoints/model_iter_20000.pth", type=str, help="model_path")
parser.add_argument("--model_path", default="/home/ac/data/lk/FP/FP_3/result/fp3_1__5_9/2025-07/voc_train_voc_26-21-18-57/checkpoints/model_iter_20000.pth", type=str, help="model_path")
parser.add_argument("--refine_with_multiscale", default=True, type=lambda x: x.lower() in ["true", "1", "yes"], help="refine_cam_with_multiscale")
parser.add_argument("--cam2seg", default=True, type=lambda x: x.lower() in ["true", "1", "yes"], help="take cam as seg")
...
parser.add_argument("--data_folder", default='/home/ac/data/lk/data/VOCdevkit/VOC2012', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='/home/ac/data/lk/FP/FP_3/datasets/voc', type=str, help="train/val/test list file")
...
def _validate(pid,model=None, dataset=None, args=None):
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            ###
            if args.cam2seg:
                cls, segs, _x4, cls_aux, attri_tokens_, score_maps, agg_f= model(inputs, cls_label=cls_label)
...
if __name__ == "__main__":
    ...
    base_dir = args.model_path.split("checkpoints/")[0] + "try"
    ...
    if args.crf_post:
        ...
        # args.logits_dir = os.path.join(base_dir,"try", f"{cpt_name}_{tag}_logits")
